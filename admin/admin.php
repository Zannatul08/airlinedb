    ...
    <div class="max-w-7xl mx-auto p-4">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <a href="medical_assistance.php"
                ...
                <p class="text-gray-600 mt-2">View and manage the medical teams for emergencies, first aid, and health
                    checks.</p>
            </a>
            <a href="ban_user.php"
                class="block p-6 bg-white border border-gray-200 rounded-lg shadow-sm hover:bg-green-50 transition">
                <h2 class="text-lg font-semibold text-green-600">Ban Users</h2>
                <p class="text-gray-600 mt-2">Ban the users for betterment.</p>
            </a>
